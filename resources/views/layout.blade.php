...
<!-- CustomerMaster -->
<li class="nav-item">
        <a class="nav-link @if(!request()->is('admin/room*')) collapsed @endif" href="#" data-toggle="collapse" data-target="#CustomerMaster"
                    aria-expanded="true" aria-controls="collapseTwo">
            ...
            <!-- Nav Item - booking -->
            <li class="nav-item">
                <a class="nav-link @if(request()->is('admin/booking*')) show @endif" href="{{url('admin/booking/create')}}">
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown no-arrow">
                            ...
                            <div class="dropdown-menu dropdown-menu-right shadow animated--grow-in"
                                ...
                                <a class="dropdown-item" href=href="{{url('admin/logout')}}" data-toggle="modal" data-target="#logoutModal">
            ...
            <footer class="sticky-footer bg-white">
                <div class="container my-auto">
                    <div class="copyright text-center my-auto">
                        <span>Copyright &copy; BookMyTable 2022</span>
                    </div>
                </div>
            </footer>
            <!-- End of Footer -->
